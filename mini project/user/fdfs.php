...
// Fetch current bookings with pickup status
$current_bookings_sql = "SELECT booking_no, pickup_date, dropoff_date, bike_no, otp, pickup_status FROM booking WHERE user_name = ? AND dropoff_date >= CURDATE()";
        ...
        <div class="col-md-8">
          ...
          <div class="current-bookings">
            ...
            <div class="alert alert-warning">
              Booking cancellation must be done a day before the pickup date.
            </div>
            <table class="table">
              <thead>
                <tr>
